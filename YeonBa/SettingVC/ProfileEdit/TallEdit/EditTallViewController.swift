...
protocol EditTallViewControllerDelegate: AnyObject {
    func favoriteTallSelected(_ mode: String)
}

class EditTallViewController: UIViewController {
    private var selectedMode: String?
    weak var delegate: EditTallViewControllerDelegate?
...
extension EditTallViewController {
