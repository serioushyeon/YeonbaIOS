//
//  ProfileVoiceEditRecodingviceController.swift
//  YeonBa
//
...
class ProfileVoiceEditRecodingviceController: UIViewController, AVAudioRecorderDelegate {
    //MARK: - UI Comaponents
    ...
    func presentPopup() {
        ...
        let popupViewController = ProfileVoiceEditPopUpViewController(title: "\(SignDataManager.shared.nickName!)님은 \(voiceMode)입니다!", desc: "연방님은 \(voiceMode)의 음역대를 가지고 계시군요!\n\(voiceMode)의 목소리를 이성에게 어필해 보세요!", navigation: navigationController, vocalRange: voiceMode )
