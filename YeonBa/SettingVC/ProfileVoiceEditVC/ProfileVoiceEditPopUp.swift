...
import Alamofire
class ProfileVoiceEditPopUp: UIView {
    ...
    init(title: String, desc: String, navigation: UINavigationController?, vocalRange : String, leftButtonTitle: String = "취소", rightButtonTitle: String = "완료") {
